...
public class UploadImageUsecase extends BaseUseCase<BaseResponse<UploadEntity>> {
    ...
    @Override
    protected Observable<BaseResponse<UploadEntity>> buildUseCaseObservable() {
    ...
    @Override
    protected DisposableObserver<BaseResponse<UploadEntity>> buildUseCaseSubscriber() {
        return new DefaultObserver<BaseResponse<UploadEntity>>() {
            @Override
