...
public class GetListMachineUsecase extends BaseUseCase<BaseListResponse<MachineEntity>>  {
    ...
    @Override
    protected Observable<BaseListResponse<MachineEntity>>  buildUseCaseObservable() {
        return remoteRepository.getListMachine();
    }

    @Override
    protected DisposableObserver<BaseListResponse<MachineEntity>> buildUseCaseSubscriber() {
        return new DefaultObserver<BaseListResponse<MachineEntity>>() {
            @Override
