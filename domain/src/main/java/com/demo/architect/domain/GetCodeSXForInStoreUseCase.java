...
public class GetCodeSXForInStoreUseCase extends BaseUseCase {
    private static final String TAG = GetCodeSXForInStoreUseCase.class.getSimpleName();
    private final OrderRepository remoteRepository;

    public GetCodeSXForInStoreUseCase(OrderRepository remoteRepository) {
        this.remoteRepository = remoteRepository;
    }

    @Override
    protected Observable buildUseCaseObservable() {
        return remoteRepository.getCodeSXForInStore();
    }
