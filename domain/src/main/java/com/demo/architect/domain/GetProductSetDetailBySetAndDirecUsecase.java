...
public class GetProductSetDetailBySetAndDirecUsecase extends BaseUseCase<BaseListResponse<ProductPackagingWindowEntity>> {
    ...
    @Override
    protected Observable<BaseListResponse<ProductPackagingWindowEntity>> buildUseCaseObservable() {
    ...
    @Override
    protected DisposableObserver<BaseListResponse<ProductPackagingWindowEntity>> buildUseCaseSubscriber() {
        return new DefaultObserver<BaseListResponse<ProductPackagingWindowEntity>>() {
            @Override
