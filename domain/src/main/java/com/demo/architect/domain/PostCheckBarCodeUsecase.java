...
public class PostCheckBarCodeUsecase extends BaseUseCase<BaseListResponse<ProductPackagingEntity>> {
    ...
    @Override
    protected Observable<BaseListResponse<ProductPackagingEntity>> buildUseCaseObservable() {
    ...
    @Override
    protected DisposableObserver<BaseListResponse<ProductPackagingEntity>> buildUseCaseSubscriber() {
        return new DefaultObserver<BaseListResponse<ProductPackagingEntity>>() {
            @Override
