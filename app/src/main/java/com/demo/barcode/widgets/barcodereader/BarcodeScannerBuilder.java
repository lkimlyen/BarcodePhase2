...
public class BarcodeScannerBuilder {
    ...
    protected BarcodeScanner.OnResultListener onResultListener;
    ...
    protected int mScannerMode = BarcodeScanner.SCANNER_MODE_FREE;

    /**
     * Default constructor
     */
    public BarcodeScannerBuilder() {
     ...
     */
    public BarcodeScannerBuilder withResultListener(@NonNull BarcodeScanner.OnResultListener onResultListener){
        this.onResultListener = onResultListener;
        return this;
    }

    /**
     * Construct a BarcodeScannerBuilder by passing the activity to use for the generation
     *
     * @param activity current activity which will contain the drawer
     */
    public BarcodeScannerBuilder(@NonNull Activity activity) {
        this.mRootView = (ViewGroup) activity.findViewById(android.R.id.content);
        this.mActivity = activity;
    }

    /**
     * Sets the activity which will be used as the parent of the BarcodeScanner activity
     * @param activity current activity which will contain the BarcodeScanner
     */
    public BarcodeScannerBuilder withActivity(@NonNull Activity activity) {
        this.mRootView = (ViewGroup) activity.findViewById(android.R.id.content);
        this.mActivity = activity;
        return this;
    }
     ...
     */
    public BarcodeScannerBuilder withFrontfacingCamera(){
     ...
     * @param cameraFacing
     */
    public BarcodeScannerBuilder withCameraFacing(int cameraFacing){
     ...
     */
    public BarcodeScannerBuilder withEnableAutoFocus(boolean enabled){
     ...
     * @param color
     */
    public BarcodeScannerBuilder withTrackerColor(int color){
        mTrackerColor = color;
        return this;
    }
     ...
     */
    public BarcodeScannerBuilder withBleepEnabled(boolean enabled){
     ...
     */
    public BarcodeScannerBuilder withText(String text){
        mText = text;
        return this;
    }
     ...
     * Shows a text message at the top of the barcode scanner
     */
    public BarcodeScannerBuilder withFlashLightEnabledByDefault(){
     ...
     * @return
     */
    public BarcodeScannerBuilder withBarcodeFormats(int barcodeFormats){
     ...
     * @return
     */
    public BarcodeScannerBuilder withOnly2DScanning() {
     ...
     * @return
     */
    public BarcodeScannerBuilder withOnly3DScanning(){
     ...
     * @return
     */
    public BarcodeScannerBuilder withOnlyQRCodeScanning(){
    ...
    public BarcodeScannerBuilder withCenterTracker(){
        mScannerMode = BarcodeScanner.SCANNER_MODE_CENTER;
        return this;
    }
     ...
     * @return
     */
    public BarcodeScannerBuilder withCenterTracker(int trackerResourceId, int detectedTrackerResourceId){
        mScannerMode = BarcodeScanner.SCANNER_MODE_CENTER;
    ...
    /**
     * Build a ready to use BarcodeScanner
     *
     * @return A ready to use BarcodeScanner
     */
    public BarcodeScanner build() {
        ...
        barcodeScanner.setOnResultListener(onResultListener);
