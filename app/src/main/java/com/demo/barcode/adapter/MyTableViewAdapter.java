...
import com.demo.barcode.widgets.tableView.Cell;
import com.demo.barcode.widgets.tableView.ColumnHeader;
import com.demo.barcode.widgets.tableView.RowHeader;
...
public class MyTableViewAdapter  extends AbstractTableAdapter<ColumnHeader, RowHeader, Cell> {
    ...
    public AbstractViewHolder onCreateCellViewHolder(ViewGroup parent, int viewType) {
        // Get cell xml layout
        View layout = LayoutInflater.from(CoreApplication.getInstance()).inflate(R.layout.my_cell_layout,
                parent, false);
    ...
    public AbstractViewHolder onCreateColumnHeaderViewHolder(ViewGroup parent, int viewType) {
        ...
        View layout = LayoutInflater.from(CoreApplication.getInstance()).inflate(R.layout
    ...
    public View onCreateCornerView() {
        ...
        return LayoutInflater.from(CoreApplication.getInstance()).inflate(R.layout.table_view_corner_layout, null);
    }
