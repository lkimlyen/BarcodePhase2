...
public class LogScanConfirmModel extends RealmObject {
    ...
    public static void createOrUpdate(Realm realm, OrderConfirmEntity orderConfirmEntity, int times,int numberConfirmed, long userId) {
        ...
        //tính sl còn lại trong lần quét này
        ...
        //kiểm tra trạng thái của chi tiết
    ...
    public static void updateNumberScan(Realm realm, long outputId, int numberScan, boolean scan) {
        ...
        if (scan) {
            //nếu là scan thì update sl xác nhận + 1(numberScan mặc định là 1) và tính toán lại sl còn lại của chi tiết
            ...
            //nếu là user nhập vào thì update sl xác nhận = numberScan và tính toán lại sl còn lại của chi tiết
